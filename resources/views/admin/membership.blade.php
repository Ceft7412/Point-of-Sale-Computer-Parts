...
@section('content')
    ...
    <div class="c-wrapper">
        ...
        <div class="m-ct-wr">
            ...
            <div class="hd-fl-ct">
                <div class="fl-per-pg">
                    <button type="button" id="archiveButton">Set as Inactive</button>
                </div>
            ...
            <form method="POST" id="archiveGroupMembers" action="{{ route('archive-members') }}">
                @csrf
                <div class="bd-ct">
                    <div class="tbl">
                        <div class="thdr">
                        ...
                        <div class="tbdy">
                            @forelse($activeMembers as $activeMember)
                                <div class="tbdy-rw">
                                    <div class="tbl-cell">
                                        <input type="checkbox" class="userCheckbox" name="memberIds[]"
            ...
            <div class="update-modal-wrapper">
                <div class="modal-card-wrapper" id="modal-card">
                    <div class="modal-flex-employee">
                        ...
                        <form  class="form-wrapper" id="update_members_form" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="modal-body">
                                ...
                                <div class="input-name input-wrapper">
                                    <div class="flex-column">
                                        <label for="">Name:</label>
                                        <input type="text" name="update_membership_name"class="input" value=""
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="input-email input-wrapper">
                                    <div class="flex-column">
                                        <label for="">Email:</label>
                                        <input type="email" name="update_membership_email" class="input" required>
                                        <div class="error"></div>
                                    </div>
                                </div>
                                <div class="input-email input-wrapper">
                                    <div class="flex-column">
                                        ...
                                        <input type="tel" name="update_membership_phone" class="input">
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
            ...
            <div class="m-m-wrapper" id="archive_modal">
                <div class="a-modal">
                    <div class="a-modal-f">
                        <div class="hdr">
                        ...
                        <div class="bdy">
                            <span class="">By confirming, the member will be set to inactive. Are you sure you want
                                to proceed?</span>
                        </div>
                        <form method="POST" id="archive_member"class="ftr">
                            @csrf
